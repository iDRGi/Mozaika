...
export default async function CatalogPage({ searchParams }: Props) {
  ...
  return (
    <div className="container-main py-10">
      <h1 className="text-2xl sm:text-3xl font-bold text-stone-800 mb-6 sm:mb-8">Каталог мебели</h1>

      <div className="overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0 mb-6 sm:mb-8">
        <div className="flex flex-nowrap sm:flex-wrap gap-2 pb-1 sm:pb-0">
          {CATEGORIES.map((cat) => (
            <a
              key={cat.value}
