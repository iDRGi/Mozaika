...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "banners" (
  	...
  	"content" varchar,
  	"type" "enum_banners_type" DEFAULT 'promo',
  ...
  CREATE TABLE IF NOT EXISTS "content_blocks" (
  	...
  	"text" varchar,
  	"image_id" integer,
  	"image_position" "enum_content_blocks_image_position" DEFAULT 'left',
  	"is_active" boolean DEFAULT true,
  ...
  CREATE INDEX IF NOT EXISTS "content_blocks_image_idx" ON "content_blocks" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "content_blocks_updated_at_idx" ON "content_blocks" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "content_blocks_created_at_idx" ON "content_blocks" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_content_blocks_id_idx" ON "payload_locked_documents_rels" USING btree ("content_blocks_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_content_blocks_image_position";
